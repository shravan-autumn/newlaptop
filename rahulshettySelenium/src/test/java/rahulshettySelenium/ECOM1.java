...
public class ECOM1 {
	...
	public static void main(String[] args) {
		...
		test(driver, itemsneeded);
	}

	public static void test(WebDriver driver, String[] itemsneeded) {
		...
		for (int i = 0; i < all.size(); i++) {
			...
			if (pro.contains(product1)) {
				...
				// break;// break wont work when we have array> bcoa it will skip abruptly
		...
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("[class=\"promoCode\"]")));
