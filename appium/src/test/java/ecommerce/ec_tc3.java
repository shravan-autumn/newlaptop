...
public class ec_tc3 extends BaseTest {
...
//		Thread.sleep(2000);
		...
		Assert.assertTrue(driver.findElement(By.xpath("//android.widget.Image[@text=\"Google\"]")).isDisplayed());
	}
